...
def retira_formatacao(num_cpf: str) -> str:
    ...
    @param num_cpf: Número de cpf com caracteres
    @return: Numero de cpf limpo
    """
    num_cpf_limpo = re.sub('[^0-9]', '', num_cpf)
    return num_cpf_limpo


def valida_cpf(num_cpf: str) -> str:
    """
    Função para validar cpf

    @param num_cpf: Número de cpf limpo
    @return: True
    """
    ...
    # resto do algoritimo que deve ser igual ao primeiro digito do cpf
    retorno2 = (retorno * 10) % 11 % 10
    ...
    # resto do algoritimo que deve ser igual ao segundo digito do cpf para ser valido
    retorno3 = (retorno * 10) % 11 % 10
    # verificando se o cpf é diferente de 11 numeros inteiros
    if len(num_cpf_limpo) != 11:
        return False

    # verificando se ambos os retornos da validação são iguais aos respectivos 2 digitos do cpf
    ...
    lista_cpfs_invalidos = ['00000000000', '11111111111', '22222222222', '33333333333', \
